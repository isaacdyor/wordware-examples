  ...
  return (
    <div>
      <div className="relative flex h-screen w-screen flex-col items-center justify-center overflow-hidden">
        ...
        <div className="fixed -z-10 h-full w-full rounded-full bg-gradient-radial from-foreground/45 via-foreground/15 to-transparent blur-3xl dark:from-foreground/15 dark:via-foreground/5" />
